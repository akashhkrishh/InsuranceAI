    ...
    return (
            ...
            <div className="h-screen w-screen overflow-y-auto flex flex-col">
                ...
                <main className="flex-1 px-8 md:px-20 flex relative">
                    ...
                    <div className={"absolute  z-50 duration-500 bottom-14 hover:scale-105 transition-all ease-in-out   select-none gap-1 right-14 flex flex-col items-center justify-center"}>
